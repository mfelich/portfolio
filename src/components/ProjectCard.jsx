        ...
        <>
            <div className="md:flex mb-8 md:mb-8 lg:mb-4 md:items-start md:justify-start lg:flex lg:items-start lg:justify-start md:space-x-4 lg:space-x-4">
                ...
                <div className="w-full md:w-1/2 lg:w-2/3">
                    <a href={project?.githubUrl} target="_blank" className="font-poppins text-white text-lg md:text-xl lg:text-xl sm:mt-0 lg:mt-0 text-left font-semibold hover:text-violet-600 cursor-pointer transition-colors duration-200">
                        {project?.title}
                    </a>
                    ...
                    <div className="flex flex-wrap items-center justify-start gap-2 mt-2">
                        {project.technologies?.map((tech, index) => (
                            <div key={index} className="px-2 py-2 bg-gray-800 w-fit rounded-md">
